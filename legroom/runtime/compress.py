...
def compress(
    ...
    **kwargs: Any,
    ...
    pipeline = TransformPipeline(
        ...
        backend=cfg.backend,
        strict=cfg.strict,
        stable_prefix_cache_enabled=cfg.stable_prefix_cache_enabled,
        stable_prefix_cache_maxsize=cfg.stable_prefix_cache_maxsize,
    )

    # Inject shared prefix cache if provided (for proxy reuse across requests)
    if shared_prefix_cache is not None:
        pipeline._stable_prefix_cache = shared_prefix_cache
